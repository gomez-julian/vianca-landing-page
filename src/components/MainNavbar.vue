...
<div class=" py-3 px-6 flex align-items-center justify-content-between relative lg:static">
    <img src="/images/logo-simple.png" alt="Image" height="60">
...
import Main3dButton from './Main3dButton.vue';
